	...
	<body class="sticky-header">
			...
			<div class="body-content" style="min-height: 1500px;">
				...
				<div class="wrapper">
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
							    <div class="badge badge-success">Last Pi Number: <?=$pin?></div>
								<div class="panel-body">
									<form autocomplete="off" id="form_add_sale_cotract" method="post" action="<?=base_url('admin/form_add_sale_contract')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form" autocomplete="on">
										<div class="form-group row">
											...
											<div class="col-lg-3">
												...
												<input  id="pi_number" required name="pi_number" type="text" placeholder="Enter PI Number" class="form-control" />
											</div>
											<div class="col-lg-3">
												<label for="pi_date" class="control-label text-danger">Pi Date*</label>
												<input  id="pi_date" name="pi_date" required type="date" class="form-control" />
											</div>
											<div class="col-lg-3">
										...
										<div class="form-group row">
											<div class="col-lg-3">
												...
												<select required name="sold_to_party_id"  id="sold_to_party_id" class="form-control select2">
										...
										<div class="form-group row">
											...
											<div class="col-lg-3">
												<label for="bank_id" class="control-label text-danger">Bank *</label>
										...
										<div class="form-group row">
											<div class="col-lg-3">
												<label for="payment_terms" class="control-label text-danger">Payment Terms</label>
												<select required name="payment_terms" data-placeholder="-- Select payment terms --" required  id="payment_terms" class="form-control select2">
													<?php
										...
										<div id="add-div" class="addrowmore">
										    ...
										    <div class="form-group row" id="formGroup_0">
												...
												<div class="col-lg-7">
													<input  id="lab_report_clauses" name="lab_report_clauses[]" placeholder="Enter Description" type="text" class="form-control"  value="" />
												</div>
												<div class="col-lg-3">
		...
		function addMore() {
			...
			var add_row ='<div class="form-group row addrowmore" id="formGroup_'+newfMaxid+'">';
						add_row += '<div class="col-lg-2"><input type="text"  placeholder="Enter Label" name="lbl[]" id="lbl" class="form-control"></div>';
						add_row += '<div class="col-lg-7">';
									add_row += '<input id="'+randId+'" name="lab_report_clauses[]" placeholder="Enter Description" type="text" class="form-control" />';
						add_row += '</div>';

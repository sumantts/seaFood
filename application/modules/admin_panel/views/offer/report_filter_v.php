                    ...
                    <div class="row ">
                        <div class="col-lg-12 ">
                            <div class=" bg-success text-white text-center ">
                                <h4 style="padding: 47px;">Report Filter</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-lg-12 " style="padding: 37px;">
                            <div class="row ">
                                <form method="post" action="<?php echo base_url('admin/report_filter_form'); ?>" target="_blank">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-3 form-group" id="product_id_exe_div">
                                            <label class="font-weight-bold">Product</label>
                                            <select name="product_id_exe" id="product_id_exe" class="form-control select2">
                                                <option value="">-- Select Product --</option>
                                                <?php foreach ($product as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value->pr_id ?>"><?php echo $value->product_name; ?></option>
                                                <?php }  ?>
                                            </select>
                                        </div>

                                        <div class="col-lg-3 form-group">
                                            <label class="font-weight-bold" for="offer_status">Offer Staus</label>
                                            <select name="offer_status" id="offer_status" class="form-control select2">
                                                <option value="">-- Select Offer Staus --</option>
                                                <?php foreach ($offer_status as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value->offer_status_id ?>"><?php echo $value->offer_status; ?></option>
                                                <?php }  ?>
                                            </select>
                                        </div>

...
<?php 
    ...
    if(empty($view_offer_data['templates'][0]) or !isset($view_offer_data['templates'][0])){
        die('Please finalise the offer and get accepted by the Trader in order to view the Offer. You can also communicate with the Trader from the <a href="'.base_url("admin/offer-comments").'">Comments Section</a>');
    ...
    $selling_prices_fields = explode(',',$templates->selling_prices_fields);
     ...
     /*echo "<pre>"; print_r($offer_details_fields);*/
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mar_bot_3">
                        <div class="col-sm-3 border_all header_left">
                            ...
                            <h4 class="">
                                <strong><?=$view_offer_data['company_details']->company_name?></strong>
                            </h4>
                            <p class="mar_0"><?=$view_offer_data['company_details']->address?></p>
                            ...
                            <div class="row">
                                <div class="col-sm-6 border_all height_135">
                                    ...
                                    <h5 class="mar_0">
                                        ...
                                        <?= $this->session->fname ?>  <?= $this->session->name ?>
                                    </h5>
                                </div>
                                <div class="col-sm-6 border_all height_135">
                                ...
                                ?>
                                    <p class="mar_0">
                                        ...
                                        <?php
                                        //print_r($view_offer_data['destination_country']);

                                        //die();

                                        if(!empty($view_offer_data['destination_country'])){
                                            foreach ($view_offer_data['destination_country'] as $key => $destination_country) {
                                            
                                                echo ($key != 0)?', '.$destination_country['destination_cntr'] .' / '. $destination_country['destination_iso']:$destination_country['destination_cntr'] .' / '. $destination_country['destination_iso'];

                                            }
                                        }else{
                                            echo "No Destination Country";
                                        }
                                        ?>
                                    </p>
                                <?php } ?>   
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col-md-4 mar_bot_3 border_all height_21"  style="height: auto !important;">
                        ...
                        <table id="" class="table table-bordered table-hover width-100 table2excel offer_details" >
                            <?php //echo "<pre>"; print_r($offer_details_fields); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach($offer_details  as $vod){
                                        ...
                                        <?php } ?> 
                                            <td>
                                                ...
                                                <?php  
                                                //if(in_array('c_id', $offer_header_fields)){
                                                echo '('. $offer_header->currency_code . ')';
                                                   //} 
                                                ?>
                                            </td>
                                        </tr>
                                    ...
                                    <?php if(in_array('product_price', $offer_details_fields)){ ?>    
                                        <th><?=number_format($total_price,2) .' ('. $offer_header->currency_code . ')' ?></th>
                                    <?php } ?>
                                    <th><?=number_format($total_amount,2) .' ('. $offer_header->currency_code . ')'?></th>
                    ...
                    if($this->session->usertype != 2){
                        ...
                        if(isset($selling_price[0]) && !empty($selling_price[0]->exchange_rate) ){        
                    ?>
                    ...
                    <form method="POST">
                                    ...
                                    <?php foreach($selling_price as $sp): ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <td> 
                                                ...
                                                <input type="hidden" value="<?=$sp->sp_id?>" name="sp_id_mail[]">
                                            </td>
                                        </tr>
                                ...
                                <table id="" class="table table-bordered table-hover width-100 table2excel offer_details" >
                                    ...
                                    <?php foreach($selling_price as $sp): ?>
                                        ...
                                        <tr>
                                            <td><?=$sp->name?></td>
                                            <td>
                                            <select disabled="" name="customer_id[]" required  class="select2 form-control">
                                                <option class="select2-ex"  value="">-- Choose from the list --</option>
                                            <?php 
                                        ...
                                        <?php } ?>
                                            ...
                                            <?php if($this->session->usertype == 3 and $sp->mar_selling_status == 0){
                                                ...
                                                ?>
                                                <form method="POST">
                                                    <input  class="form-control" type="number" step="0.50" name="mar_selling_rate">
                                                    <input type="submit" class="btn btn-info btn-sm" name="upgrade_rate"  value="Request">
                                                    <!-- HIDDEN FIELDS11 -->
                                                    <input type="hidden" value="<?=$sp->final_selling_price?>" name="mar_base_price">
                                                    <input type="hidden" value="<?=$sp->sp_id?>" name="mar_sp_id">
                        ...
                        <div class="row">
                            <div class="pull-right">
                                ...
                                <?php //echo $offer_header->final_marketing_approval_status; ?>
                                <?php if($this->session->usertype == 1 or $this->session->usertype == 3 and $offer_header->final_marketing_approval_status == 1){ ?>

...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <div class="wrapper">
          ...
          <div class="row mt-3">
              <div class="col-lg-12 " style="padding-top: 37px;">
              	<div class="row ">
                  <form method="post" action="<?php echo base_url('admin/generate-report'); ?>" target="_blank">
                    <div class="col-lg-2">
                      <label for="report_temp" class="col-form-label">Choose Report Type:</label>
                    </div>
                    <div class="col-lg-7">
                     <select name="report_temp" required="" id="report_temp" class="form-control select2">

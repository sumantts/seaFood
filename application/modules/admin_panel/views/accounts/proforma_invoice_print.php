<!--< ?= '<pre>',print_r($details[0]['incoterm']), '</pre>';?>-->
...
<html lang="en">
    ...
    <!-- Set also "landscape" if you need -->
    <body class="A3 landscape" id="page-content">
        ...
        if(!isset($details[0])){
            die("No Selling Pricing is Done");
        }
        
        ?>
        
        <section class="sheet padding-10mm"  style="width:100%">
            <div>
                ...
                <div class="container">
                    ...
                    <div class="row mar_bot_3">
                        ...
                        <div class="col-sm-5">
                            ...
                            <!--    </div>-->
                            <!--    <div class="col-sm-7">-->
                            <!--        <p><strong><?=$details[0]['incoterm']?></strong></p>-->
                            <!--    </div>-->
                            <!--</div>-->
                        </div>
                    </div>
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr class="text-center">
                                   ...
                                   >Product(s)</th>
                                   <?php if(in_array('product_line_sc', $template)){ ?>
                                    <th>Product Line(SC)</th>
                                    <?php } ?>
                                    <?php
                                    ...
                                    ?>   
                                      ...
                                      <?php }elseif($template[$it] == "product_line"){ ?>
                                    ...
                                    <?php }elseif($template[$it] == "comment"){ ?>
                                        <th>Comment</th>
                                      <?php }else{  if($template[$it] != 'p_scientific_name' && $template[$it] != 'gross_weight' && $template[$it] != 'product_line_sc'){?>
                                        <th>
                                            <?php
                                             echo $template[$it];
                                            ?>
                            ...
                            <tbody class="actual_table">
                                ...
                                <tr>
                                    ...
                                    <?php }elseif($template[$itd] == "unit_id"){?>
                                            <td><?= $d['unit'] ?></td>
                                    <?php }else{ if($template[$itd] != "p_scientific_name" && $template[$itd] != 'gross_weight' && $template[$itd] != 'product_line_sc'){?>
                                        <td><?php

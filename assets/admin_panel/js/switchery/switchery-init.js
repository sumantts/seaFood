...
// var switchery = new Switchery(secondary, { color: '#64BD63', secondaryColor: '#ff8787' });
var secondary = Array.prototype.slice.call(document.querySelectorAll('.js-switch-secondary'));
secondary.forEach(function(element) {
  var switchery = new Switchery(element, { color: '#64BD63', secondaryColor: '#ff8787' });
});
